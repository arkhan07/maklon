...
@section('breadcrumb')
    ...
    <span class="text-primary font-medium">Tambah Produk</span>
@endsection
...
<div class="p-8 space-y-6 max-w-2xl">
    <div class="flex items-center justify-between">
        <div>
            <h2 class="text-2xl font-bold text-slate-900">Tambah Produk</h2>
            <p class="text-slate-500 text-sm">Buat entri produk maklon baru</p>
        </div>
    ...
    <div class="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
        ...
        <form method="POST" action="{{ route('admin.produk.store') }}" class="p-6 space-y-5">
            @csrf
            ...
            <div>
                ...
                <input
                    ...
                    name="slug"
                    value="{{ old('slug') }}"
                    placeholder="Akan digenerate otomatis dari nama"
                ...
                >
                <p class="mt-1 text-xs text-slate-400">Kosongkan untuk generate otomatis dari nama produk</p>
                @error('slug')
                <p class="mt-1 text-xs text-red-500">{{ $message }}</p>
                @enderror
            </div>
